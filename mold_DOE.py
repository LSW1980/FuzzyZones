...
# absolute path i.e. ==> 'C:/user/data/Mold_DOE.xlsx'
...
SS_e = SS_T - (SS_Temp + SS_Time + SS_Press + SS_TempTime + SS_TimePress + SS_TempPress)
...
# print ANOVA results and show three graphs
print(anovaMold)
plt.show()
